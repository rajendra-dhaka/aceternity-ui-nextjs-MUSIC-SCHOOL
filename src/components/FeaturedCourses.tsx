...
const FeaturedCourses = () => {
  const featuredCoursesData = coursesData?.courses.filter(
  ...
  return (
    <div className="min-h-screen py-12 bg-gray-900">
      ...
      <div className="mt-20 text-center">
        <Link
          href={"/courses"}
          className="px-4 py-2 rounded-md border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-200 transition duration-200"
        >
          View All Courses
        </Link>
      </div>
